...
def build_catalog_prompt(chroma_rgb: tuple[int, int, int]) -> str:
    ...
    return (
        ...
        "Keep the exact source camera angle, orientation, crop, and view: front, side, "
        "back, and three-quarter views must remain that same view. Never rotate, mirror, "
        "or turn a side-profile product into a front-facing one. "
